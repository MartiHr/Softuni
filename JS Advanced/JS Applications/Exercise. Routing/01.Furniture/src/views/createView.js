        ...
        <div class="row space-top">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control${errors ? (!errors.make ? ' is-valid' : ' is-invalid') : ''}" id="new-make" type="text" name="make">
                </div>
                <div class="form-group has-success">
                    <label class="form-control-label" for="new-model">Model</label>
                    <input class="form-control${errors ? (!errors.model ? ' is-valid' : ' is-invalid') : ''}" id="new-model" type="text" name="model">
                </div>
                <div class="form-group has-danger">
                    <label class="form-control-label" for="new-year">Year</label>
                    <input class="form-control${errors ? (!errors.year ? ' is-valid' : ' is-invalid') : ''}" id="new-year" type="number" name="year">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control${errors ? (!errors.price ? ' is-valid' : ' is-invalid') : ''}" id="new-price" type="number" name="price">
                </div>
                <div class="form-group">
                    <label class="form-control-label" for="new-image">Image</label>
                    <input class="form-control${errors ? (!errors.image ? ' is-valid' : ' is-invalid') : ''}" id="new-image" type="text" name="img">
                </div>
                <div class="form-group">
