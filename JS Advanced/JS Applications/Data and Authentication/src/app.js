...
window.addEventListener('load', async () => {
    ...
    const guestNavigationElement = document.getElementById('guest');
    const usernameNavigationElement = document.getElementById('user');
    ...
    if (accessToken) {
        usernameNavigationElement.style.display = 'inline';
    } else {
